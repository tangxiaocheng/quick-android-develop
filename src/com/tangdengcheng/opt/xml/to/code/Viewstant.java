...
public class Viewstant {
	...
	static final Map<String, String> ANDROID_VIEW_MAP = new HashMap<String, String>() {
		...
		private static final long serialVersionUID = 949320914180190522L;
		{
			...
			put(IMAGE_VIEW,
					Import.IMPORT_ANDROID_WIDGET+IMAGE_VIEW+";");
			put(LINEAR_LAYOUT,
					Import.IMPORT_ANDROID_WIDGET+LINEAR_LAYOUT+";");
			put(RELATIVE_LAYOUT,
					Import.IMPORT_ANDROID_WIDGET+RELATIVE_LAYOUT+";");
			put(SCROLL_VIEW,
					Import.IMPORT_ANDROID_WIDGET+SCROLL_VIEW+";");
			put(TEXT_VIEW, Import.IMPORT_ANDROID_WIDGET+TEXT_VIEW+";");
			put(LIST_VIEW, Import.IMPORT_ANDROID_WIDGET+LIST_VIEW+";");
			put(EXPANDABLE_LIST_VIEW,
					Import.IMPORT_ANDROID_WIDGET+EXPANDABLE_LIST_VIEW+";");
			put(CHECK_BOX,
					Import.IMPORT_ANDROID_WIDGET+CHECK_BOX+";");
			put(EDIT_TEXT,
					Import.IMPORT_ANDROID_WIDGET+EDIT_TEXT+";");
			put(RADIO_GROUP,
					Import.IMPORT_ANDROID_WIDGET+RADIO_GROUP+";");
			put(RADIO_BUTTON,
					Import.IMPORT_ANDROID_WIDGET+RADIO_BUTTON+";");
			put(TOGGLE_BUTTON,
					Import.IMPORT_ANDROID_WIDGET+TOGGLE_BUTTON+";");
			
			put(WEB_VIEW,
					Import.IMPORT_ANDROID_WEBKIT+WEB_VIEW+";");
		}
	};
	
	
	public static void main(String[] args) {
		String path ="/Users/tangdengcheng/Documents/github_workplace/JavaBase/JavaUtil/src/com/tangdengcheng/opt/xml/to/code/";
		for (Iterator<String> iterator = ANDROID_VIEW_MAP.keySet().iterator(); iterator
				.hasNext();) {
...
//			}
	...
	public static final String ANDROID_XML_HEAD = " xmlns:android=" + SHUANG_YIN_HAO+ "http://schemas.android.com/apk/res/android"+ SHUANG_YIN_HAO
