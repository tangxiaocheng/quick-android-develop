...
public class JsonToXMLBat {
  ...
  /**
   * For specail char there are bugs using this way to format xml string Don't suggest to use this
  ...
  public static void main(String[] args) {
    String jsonString =
        FileService.readStringFromFile(Viewstant.PROJECT_FILE_PATH, "view_tree.json");

    //  System.out.println(prettyFormat(toXml(jsonString),4));
    System.out.println(toXml(jsonString));
  }
}
