/**
 * 文 件 名:  Debug.java
 * 版    权:  Wuhan ArcherMind Technology  All rights reserved
 * 描    述:   打印日志工具类
 * 修 改 人:  002300 梅义
 * 修改时间:  2012-10-30
 */
...
public class MyDebug {
     ...
     * @param suffix 文件后缀
     */
    public static void saveStringToFileBySuffix(String name, String log,
     ...
     * @param suffix 文件后缀
     */
    public static void saveStringToFile(String name, String log,
 String suffix) {
